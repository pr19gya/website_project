    ...
    return (
      <div className="flex justify-between items-center mb-4">
        <button
          ...
          className="text-xl p-2 bg-gray-200 rounded-md shadow hover:bg-gray-300"
        >
          &lt;
        </button>
  ...
  const renderCells = () => {
    ...
    while (day <= endDate) {
      for (let i = 0; i < 7; i++) {
        ...
        days.push(
          <div
            className={`p-1 text-center flex-1 border border-gray-200 ${
          ...
          >
            ...
            <div className="block text-xs sm:text-sm text-red-500 mt-1">
              {eventText && (
                <span className="inline-block max-w-full overflow-hidden overflow-ellipsis whitespace-nowrap">
                  {eventText}
                </span>
              )}
            </div>
