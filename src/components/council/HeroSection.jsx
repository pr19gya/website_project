...
const HeroSection = () => {
  return (
    <div className='relative h-[650px] w-full'>
      <img src="/1712478256008.jpg" className='h-full w-full object-cover' alt="Background"/>
      ...
      <motion.div
        ...
        className='absolute inset-0 flex bg-black bg-opacity-40 flex-col justify-center items-center text-center px-6 md:px-10 lg:px-20'
      >
